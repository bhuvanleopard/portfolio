...
const NavBar = function(){
    ...
    return (<div>
        ...
        <nav className="hidden md:flex justify-center items-center gap-8 pt-1">
            ...
            <a className="nav-bar-item" href="#about-me">ABOUT</a>
        ...
        <div id='mobileMenu' className="hidden fixed items-center pt-[8rem]  w-full h-full bottom-0 right-0 left-0 p-4 md:hidden
         bg-black/90 z-90 ">
            ...
            <a onClick={toggleMobileMenu} className="cursor-pointer text-2xl tracking-[8px] transition-colors hover:text-gray-300 z-100 font-extrabold px-6 py-3 border-white/50 text-center" href="#home">HOME</a>
            <a onClick={toggleMobileMenu} className="cursor-pointer text-2xl tracking-[8px] transition-colors hover:text-gray-300 z-100 font-extrabold px-6 py-3 border-white/50 text-center" href="#about-me">ABOUT</a>
